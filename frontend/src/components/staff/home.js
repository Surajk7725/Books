      ...
      <div className="mt-4 flex justify-between">
        ...
        <p className="text-sm font-medium text-gray-900">$34.99</p>
          ...
          <div className="mt-10 text-center">
            <a href="#" className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-primary hover:bg-secondary transition duration-300">
              Shop All Deals
