    ...
    <div className="justify-center items-center min-h-screen mb-2 ml-12">
      <div className="text-start -mt-4 mb-8">
        <div className="bg-white p-4 rounded-lg shadow-md mb-6 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-gray-800 ml-4">Edit Staff</h1>
          <Breadcrumb>
      ...
      <Card className="w-full max-w-6xl p-8">
        <h2 className="text-2xl font-semibold text-center mb-6">Edit Staff</h2>
        <Form form={form} layout="vertical" onFinish={handleFinish}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Form.Item label="Contact Information (Phone)" name="phone" rules={[{ required: true, message: 'Please enter the phone number' }]}>
              <Input />
            </Form.Item>
          </div>
          ...
          <Form.Item label="Job Title" name="jobTitle" rules={[{ required: true, message: 'Please enter the job title' }]}>
            <Input />
          </Form.Item>
          ...
          <Form.Item label="Highest Education Level" name="educationLevel" rules={[{ required: true, message: 'Please select the highest education level' }]}>
          ...
          <Form.Item label="Years of Experience in Libraries" name="yearsExperience" rules={[{ required: true, message: 'Please enter the years of experience' }]}>
            <Input type="number" />
          </Form.Item>
