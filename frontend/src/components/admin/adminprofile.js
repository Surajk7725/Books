...
// import { Card, Avatar, Upload, Input, Button } from 'antd';
// import { UploadOutlined, LinkedinOutlined, InstagramOutlined, TwitterOutlined, YoutubeOutlined } from '@ant-design/icons';

// const ProfilePage = () => {
//   const profilePictureUrl = 'https://wallpapers.com/images/hd/yuuichi-katagiri-anime-portrait-5xl430n009kmsg7l.jpg';
//   const coverImageUrl = 'https://i.pinimg.com/originals/84/d3/fa/84d3fa68414aecbc3172909302cb5144.jpg';

//   return (
//     <div className="flex justify-center items-center min-h-screen bg-gray-100 p-4">
//       <Card className="w-full max-w-9xl shadow-lg p-0">
//         <div className="w-full h-48 object-cover" style={{ backgroundImage: `url(${coverImageUrl})` }}>
...
//           <Upload showUploadList={false} className="relative">
//             <Avatar
//               src={profilePictureUrl}
//               alt="Profile"
//               className="w-2 h-2 object-cover rounded-full border-4 border-white"
//             />
//             <Button
//               icon={<UploadOutlined />}
...
//         </div>
//         <div className="p-4">
//           <h2 className="text-center text-2xl font-semibold">Danish Heilum</h2>
//           <p className="text-center text-gray-500">UI/UX Designer</p>
//           <div className="flex justify-around mt-4">
//             <div className="text-center">
//               <h3 className="text-lg font-semibold">259</h3>
//               <p className="text-gray-500">Posts</p>
//             </div>
//             <div className="text-center">
//               <h3 className="text-lg font-semibold">129K</h3>
//               <p className="text-gray-500">Followers</p>
//             </div>
//             <div className="text-center">
//               <h3 className="text-lg font-semibold">2K</h3>
    ...
    <>
      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="relative z-20 h-35 md:h-65">
          <img
            src="https://i.pinimg.com/originals/84/d3/fa/84d3fa68414aecbc3172909302cb5144.jpg"
            alt="profile cover"
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              <img src="https://wallpapers.com/images/hd/yuuichi-katagiri-anime-portrait-5xl430n009kmsg7l.jpg" alt="profile" />
              <label
                htmlFor="profile"
